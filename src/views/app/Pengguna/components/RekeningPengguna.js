              ...
              <Col lg={12}>
                {ubahData ? (
                  <Select
                    ...
                    defaultValue={
                      data.namaBank
                        ? { value: data.namaBank, label: data.namaBank }
                        : 'Pilih Bank'
                    }
                    name="color"
                  ...
                  <p className="detail-pengguna-rekening text-rekening">
                    {' '}
                    {data.namaBank !== null ? data.namaBank : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  <input
                    name="noRekening"
                    type="number"
                    className="detail-pengguna-input form-input text-rekening"
                    onChange={(e) =>
                      setData({ ...data, noRekening: e.target.value })
                    }
                    placeholder="No. rekening pengguna..."
                    value={data.noRekening}
                  />
                ) : (
                  <p className="detail-pengguna-rekening text-rekening">
                    {' '}
                    {data.noRekening !== null ? data.noRekening : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  <input
                    ...
                    value={data.pemilikRekening}
                  />
                ) : (
                  <p className="detail-pengguna-rekening text-rekening">
                    {data.pemilikRekening !== null ? data.pemilikRekening : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
