...
const DataPengguna = ({ id }) => {
  ...
  const handleImgProfil = (image) => {
    if (!image) {
      ...
      return image
    } else if (dataUser.photo.slice(0, 7) === '/images') {
  ...
  const handleCheckUsername = () => {
    ...
    http
      .post(`${API_URL}/api/admin/users/${id}/check-username`, {
  ...
  const onSubmit = (e) => {
    ...
    http
      .post(`${API_ENDPOINT.GET_ALL_USER}/${id}?_method=PUT`, data)
      .then(() => {
        setFetchStatus(true)
        setUbahData(false)
      })
      .catch((e) => {
        console.error('Ubah Profil Bermasalah ', e)
      })
  }
        ...
        <div className="d-flex flex-md-row flex-sm-column">
          <div className="col-4">
            ...
            <FormGroup>
              ...
              <Col lg={12}>
                <p className="detail-pengguna-text text-primary">
                ...
                <>
                  ...
                  <Col lg={12}>
                    {ubahData ? (
                      ...
                      <p className="detail-pengguna-text">
                        {dataUser.tanggal_berdiri
                          ? dataUser.tanggal_berdiri
                          : '-'}
                      </p>
                    )}
                ...
                <>
                  ...
                  <Col lg={12}>
                    {ubahData ? (
                      ...
                      <p className="detail-pengguna-text">
                        {dataUser.tanggal_lahir ? dataUser.tanggal_lahir : '-'}
                      </p>
                    )}
                  </Col>
                </>
              ...
              <Col lg={12}>
                {ubahData ? (
                  <Select
                    ...
                    value={
                      optionsProvinsi.value === null
                        ? ''
                        : optionsProvinsi.value
                    }
                  ...
                  <p className="detail-pengguna-text">
                    {dataUser.provinsi ? dataUser.provinsi : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
            ...
            <FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  ...
                  <p className="detail-pengguna-text">
                    {dataUser.alamatLengkap ? dataUser.alamatLengkap : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
              ...
              <Col lg={12}>
                ...
                <div className={`${ubahData && 'd-none'}`}>
                  {!ubahData && dataUser.photo ? (
                    <img
                      src={handleImgProfil(dataUser?.photo)}
                ...
                {ubahData && (
                  <span style={{ cursor: 'pointer' }}>
                    <Input
                      ...
                      onChange={loadImage}
                    />
                    <label htmlFor="photoProfil" className="foto-profil">
                      {' '}
                      {dataUser.photo ? (
                        <img
                          src={
                            fotoProfileUrl
                              ? fotoProfileUrl
                              : handleImgProfil(dataUser?.photo)
                          }
                          alt="Preview Image"
                          className="foto-profil"
                        />
            ...
            <FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  ...
                  <p className="detail-pengguna-text text-primary">
                    {dataUser.no_telp ? `+62${dataUser.no_telp}` : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
                  ...
                  <Col lg={12}>
                    {ubahData ? (
                      <Select
                        ...
                        styles={penggunaSelect}
                        noOptionsMessage={() =>
                          'Jenis Organisasi Tidak Ditemukan :('
                        }
                ...
                {ubahData ? (
                  <Select
                    ...
                    defaultValue={
                      dataUser.kabupaten
                        ? {
                            value: dataUser.kabupaten,
                            label: dataUser.kabupaten,
                          }
                        : 'Pilih Kota/kabupaten'
                    }
                    value={
                      optionsKabupaten.value === null
                        ? ''
                        : optionsKabupaten.value
                    }
                    styles={penggunaSelect}
                  ...
                  <p className="detail-pengguna-text">
                    {dataUser.kabupaten ? dataUser.kabupaten : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  <Select
                    ...
                    value={
                      optionsJenisAkun.value === null
                        ? ''
                        : optionsJenisAkun.value
                    }
                    styles={penggunaSelect}
                    ...
                    {ubahData ? (
                      <Select
                        ...
                        defaultValue={
                          dataUser.pekerjaan
                            ? {
                                value: dataUser.pekerjaan,
                                label: dataUser.pekerjaan,
                              }
                            : 'Pilih Pekerjaan'
                        }
                        value={
                      ...
                      <p className="detail-pengguna-text">
                        {dataUser.pekerjaan ? dataUser.pekerjaan : '-'}
                      </p>
                    )}
                  </Col>
                </>
            ...
            <FormGroup>
              ...
              <Col lg={12}>
                {ubahData ? (
                  ...
                  <p className="detail-pengguna-text">
                    {dataUser.kecamatan ? dataUser.kecamatan : '-'}
                  </p>
                )}
              </Col>
            </FormGroup>
        ...
        <div className="button-box mt-2 col-12">
          {ubahData ? (
            validator() ? (
              ...
              <button className="button-simpan-disabled" disabled>
                simpan
              </button>
            )
          ) : (
